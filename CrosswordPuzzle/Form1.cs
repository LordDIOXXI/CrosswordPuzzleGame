...
namespace CrosswordPuzzle
{
    public partial class Form1 : Form
    {
        ...
        {
            MessageBox.Show("Help About", "By Jacob");
        }
        ...
        private void board_CellValueChanged(object sender, DataGridViewCellEventArgs e)
        {
            ...
            //truncate to one leter
            try
            {
                if(board[e.ColumnIndex, e.RowIndex].Value.ToString().Length > 1)
                    board[e.ColumnIndex, e.RowIndex].Value = board[e.ColumnIndex, e.RowIndex].Value.ToString().ToUpper().Substring(0,1);
            }
            catch { }

            //format color is correct
            try
            {
        ...
        private void board_CellPainting(object sender, DataGridViewCellPaintingEventArgs e)
        {
            ...
            //foreach(item c in List of iems)
